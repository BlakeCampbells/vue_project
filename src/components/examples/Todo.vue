          ...
          <div class="card-content white-text">
            <div class="left-align">
              <span class="card-title">
                <input type="checkbox" :id="'todo__checkbox--' + index" v-model="item.checked" value="true">
                <label :for="'todo__checkbox--' + index" class="black-text">{{ item.name }}</label>
      ...
      <div class="col s12 m12">
        <div class="card white">
          <div class="card-content black-text">
            <div class="left-align">
              <span class="card-title">
                <input type="text" name="name" v-model="newTask.name">
                <a class="btn-floating right blue lighten-2" @click="addTask(newTask)"><i class="material-icons">add</i></a>
              </span>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    addTask: function (task) {
      ...
      this.newTask = { name: '', checked: false }
    },
